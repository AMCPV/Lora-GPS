    ...
    case 2:
        {
           ...
           // pressure = ( uint16_t )( MPL3115ReadPressure( ) / 10 );             // in hPa / 10
            ...
            AppData[0] = ( Gps.LatitudeBinary >> 16 ) & 0xFF;
            AppData[1] = ( Gps.LatitudeBinary >> 8 ) & 0xFF;
            AppData[2] = Gps.LatitudeBinary & 0xFF;
            AppData[3] = ( Gps.LongitudeBinary >> 16 ) & 0xFF;
            AppData[4] = ( Gps.LongitudeBinary >> 8 ) & 0xFF;
            AppData[5] = Gps.LongitudeBinary & 0xFF; 
            AppData[6] = ( altitudeGps >> 8 ) & 0xFF;
            AppData[7] = altitudeGps & 0xFF;
            AppData[8] = 0;
            AppData[9] = 0;//( pressure >> 8 ) & 0xFF;
            AppData[10] = 0;//pressure & 0xFF;
            AppData[11] = 0;//( temperature >> 8 ) & 0xFF;
            AppData[12] = 0;//temperature & 0xFF;
            AppData[13] = 0;//( altitudeBar >> 8 ) & 0xFF;
            AppData[14] = 0;//altitudeBar & 0xFF;
            AppData[15] = 0;//batteryLevel;
#elif defined( USE_BAND_915 ) || defined( USE_BAND_915_HYBRID )
            int16_t temperature = 0;
            int32_t latitude, longitude = 0;
